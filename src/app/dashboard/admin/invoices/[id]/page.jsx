...
export default function InvoiceDetailPage() {
    ...
    try {
      ...
      const res = await fetch(`/api/invoices/${params.id}`, {
        ...
        body: JSON.stringify({
          ...
          professionalServiceCharges: Number(form.professionalServiceCharges || 0),
            ...
            {loading ? (
              ...
              <>
                <div className="no-print grid gap-6 xl:grid-cols-[1.1fr_.9fr]">
                  <div className="rounded-3xl bg-white p-4 sm:p-8 shadow-sm ring-1 ring-slate-200">
                    <div className="overflow-auto rounded-2xl border border-slate-200 bg-slate-50 p-4">
                      <div
                        className="invoice-pdf-page mx-auto"
                        style={{
  ...
  />
                        ...
                        <div className="pt-10">
                          ...
                          <div className="mt-14">
                            ...
                            <div className="mt-5 space-y-4 text-[13px] text-slate-900">
                              <div className="uppercase">{item.clientName}</div>
                            ...
                            <table className="w-full border-collapse text-[13px]">
                              <tbody>
                                ...
                                <tr className="border-b border-slate-300">
                                  ...
                                  <td className="px-4 py-4 text-center">
                                    ${Number(form.professionalServiceCharges || 0).toFixed(2)}
                                  </td>
                                </tr>
                        ...
                        <div className="grid grid-cols-2 gap-6 px-0 py-4 text-[12px] text-[#183d75]">
                          <div className="leading-6">
                            <div>6675 Mediterranean Dr, Suite 304, McKinney, TX 75072</div>
                    ...
                    <form onSubmit={handleSave} className="space-y-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setForm({ ...form, billingDateFrom: e.target.value })
                          }
                          className="w-full rounded-xl border border-slate-200 px-4 py-3 outline-none focus:border-sky-500 focus:ring-4 focus:ring-sky-100"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setForm({ ...form, billingDateTo: e.target.value })
                          }
                          className="w-full rounded-xl border border-slate-200 px-4 py-3 outline-none focus:border-sky-500 focus:ring-4 focus:ring-sky-100"
                        />
                      </div>
